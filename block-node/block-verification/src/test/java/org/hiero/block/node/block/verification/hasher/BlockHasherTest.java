...
class BlockHasherTest {
    ...
    class ForwardCompatibilityTests {
        ...
        /// unknown field is rejected as malformed: a BlockItem is a protobuf oneof, so a valid
        /// item carries exactly one field.
        @Test
        ...
        void testKnownItemWithUnknownFieldRejected() throws ParseException {
            ...
            assertHashingFails(item, SessionFailureType.UNABLE_TO_PARSE);
        }

        /// This test aims to assert that an item carrying more than one unknown field is
        /// rejected as malformed: a BlockItem is a protobuf oneof, so a valid item carries
        /// exactly one field.
        @Test
